...
case "vulExists":{
        ...
        getRemediationActionForLeaf_extraction_1(leaf,topology,conn,costParametersFolder,useSnortRule,result,remediateVulnerability,vulnerability,attackerPath,patches);
        break;
      }
