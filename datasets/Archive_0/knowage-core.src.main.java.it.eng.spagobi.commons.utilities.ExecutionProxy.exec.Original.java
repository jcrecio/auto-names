...
public byte[] exec(IEngUserProfile profile,String modality,String defaultOutputFormat){
  ...
  try {
    ...
    if ("it.eng.spagobi.engines.drivers.cockpit.CockpitDriver".equals(eng.getDriverName()) || "it.eng.spagobi.engines.drivers.chart.ChartDriver".equals(eng.getDriverName())) {
